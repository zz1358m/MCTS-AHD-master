...
with open("instance/botorch_problem_train.pkl", "wb") as f:
...
# Save the real_problem_list to a pickle file
with open("instance/botorch_problem_val.pkl", "wb") as f:
    pickle.dump(real_problem_list, f)
...
# Save the real_problem_list to a pickle file
with open("instance/botorch_problem_test.pkl", "wb") as f:
    pickle.dump(real_problem_list, f)