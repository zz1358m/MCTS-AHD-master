...
def EvalEGO(interface_eval):
    ...
    gap_all = Parallel(n_jobs=10, timeout=time_limit)(
        delayed(interface_eval.EGO)(cost_total=12, real_problem=instance, random_seed=trial)
...
if __name__ == "__main__":
    ...
    data = os.path.join(basepath, f'instance/botorch_problem_{mood}.pkl')
